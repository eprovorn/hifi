...
c-----------------------------------------------------------------------
     ...
     $     jc_norm = 1., eta_anm_norm = 1., deta_dj_norm = 1.
...
c-----------------------------------------------------------------------
     ...
     $     hyper_eta,bz0,p0,R0,epsilon, c_rho, c_T
...
c-----------------------------------------------------------------------
     ...
     $     *b0/(n0*mp*SQRT(Zeff))
      ...
      jc_norm = 2.14*qe*R0*SQRT(mu0*n0/mp)
      eta_anm_norm = 1.4e-3*(3.e8)*mp/(42.85*qe*b0*R0)

c      eta_anm_norm = 1.4*(3.e8)**2*SQRT(mu0*mp)/(5.64e4*R0*b0)
c      deta_dj_norm = (3.e8)**2*SQRT(me/mu0)/(36.*5.64e-3*3.e5*qe*n0*R0) 
...
c Elena default case?
     ...
     $        deta_dj_norm,0._r8,etas_norm,0._r8,0._r8,0._r8,eta,
     ...
     $        u(9,:,:)+pt0, jtot,jc_norm,eta_anm_norm,deta_dj_norm,
